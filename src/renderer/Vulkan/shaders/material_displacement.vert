...
// Vulkan port of Quake 4's shipped glprogs/glsl/displacement.glslvp.
//
// Full idDrawVert locations are stable across the native material-program
// runner.  This family consumes position, color, and the base texture
// coordinate; normal/tangents are intentionally absent from the interface.
