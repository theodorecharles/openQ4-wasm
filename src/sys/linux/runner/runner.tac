...
doomService( '/home/timo/runner/doom.x86', '+set r_fullscreen 0 +set in_nograb 1 +set si_pure 0 +set com_makingBuild 1 +set s_forceWav 1 +set s_maxSoundsPerShader 0 +set s_constantAmplitude 1 +set fs_basepath /home/timo/Id/DoomBase +set fs_copyfiles 3', maps, sort = 1, multiplayer = multiplayer, blank_run = blank_run ).setServiceParent( application )
