...
{
	rvGEPropertyPage* page = reinterpret_cast< rvGEPropertyPage * >( GetWindowLongPtr( hwnd, GWLP_USERDATA ) );
	...
	if ( msg == WM_INITDIALOG )
	{
		...
		SetWindowLongPtr( hwnd, GWLP_USERDATA, reinterpret_cast< LONG_PTR >( page ) );
		page->mPage = hwnd;
